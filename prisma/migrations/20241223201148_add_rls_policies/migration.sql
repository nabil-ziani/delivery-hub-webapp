...
-- CreateIndex
CREATE UNIQUE INDEX "restaurant_profiles_organization_id_key" ON "public"."restaurant_profiles"("organization_id");
...
-- AddForeignKey
ALTER TABLE "public"."restaurant_profiles" ADD CONSTRAINT "restaurant_profiles_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."invite_tokens" ADD CONSTRAINT "invite_tokens_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
